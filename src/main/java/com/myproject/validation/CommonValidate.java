...
public class CommonValidate {
    ...
    public void checkValidPhoneNumber(String phoneNumber){
        ...
        if(!matcher.matches()){
            throw new OctIllegalRequestException(ErrorMessages.INVALID_VALUE, new ApiMessageError(MessageErrorConst.INVALID_PHONE_NUMBER));
        }
    }
    ...
    public void checkValidIdNumber(String idNumber){
        ...
        if(!matcher.matches()){
            throw new OctIllegalRequestException(ErrorMessages.INVALID_VALUE, new ApiMessageError(MessageErrorConst.INVALID_IDENTIFICATION_NUMBER));
        }
    }
    ...
    public void checkValidUsername(String username){
        ...
        if(!matcher.matches()){
            throw new OctIllegalRequestException(ErrorMessages.INVALID_VALUE, new ApiMessageError(MessageErrorConst.USERNAME_INVALID));
        }
    }
    ...
    public void checkValidPassword(String password){
        ...
        if(!matcher.matches()){
            throw new OctIllegalRequestException(ErrorMessages.INVALID_VALUE, new ApiMessageError(MessageErrorConst.PASSWORD_INVALID));
        }
    }
    ...
    public void checkValidDate(LocalDate date) {
        ...
        if (date.isAfter(currentDate)) {
            throw new OctIllegalRequestException(ErrorMessages.INVALID_VALUE, new ApiMessageError(MessageErrorConst.DATE_INVALID));
        }
    }
